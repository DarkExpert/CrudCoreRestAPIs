...
namespace SDWrox.API.Services
{
    public class UserService : IUserService
    {
        private readonly AppSettings _appSettings;
        private readonly SecurityModelContext db;

        public UserService(IOptions<AppSettings> appSettings, SecurityModelContext _db)
        {
        ...
        public async Task<AuthenticateResponse?> Authenticate(AuthenticateRequest model)
        {
            ...
            return new AuthenticateResponse(user.Id, user.FirstName, user.LastName, user.Username, token);
        }
